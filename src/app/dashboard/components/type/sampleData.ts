...
export const sampleReports: Report[] = [
  ...
  },
  {
    ...
    status: "Rejected",
    description:
      "The login page is vulnerable to XSS attacks due to unsanitized user input.",
    cvssScore: "7.5",
    vulnerableUrl: "https://example.com/login - Login Page",
    vulnerableParam: "username parameter",
    impact:
      "An attacker can inject malicious scripts that execute when other users view the page, potentially stealing session cookies or personal information.",
    stepsToReproduce: [
  ...
  },
  {
    ...
    impact:
      "An attacker can execute arbitrary SQL commands on the database, potentially accessing, modifying, or deleting sensitive data.",
    stepsToReproduce: [
  ...
  },
  {
    ...
    status: "Pending",
    description:
      "Users can access resources belonging to other users by manipulating resource identifiers.",
    cvssScore: "7.8",
    vulnerableUrl: "https://example.com/profile - User Profile",
    vulnerableParam: "userId parameter",
    impact:
      "An attacker can access or modify other users' data by manipulating object references in requests.",
    stepsToReproduce: [
      "Log in to a user account.",
      "Navigate to the profile page.",
      "Change the userId parameter in the URL to another user's ID.",
    ],
    pocImages: [{ src: "/download3.svg", alt: "PoC 1" }],
  },
];
